...
public class AddPropertyInformationCustomView extends ConstraintLayout {
    ...
    public AddPropertyInformationCustomView(@NonNull Context context) {
        super(context);
    }
    ...
    public AddPropertyInformationCustomView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public AddPropertyInformationCustomView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
